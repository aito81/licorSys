...
import py.com.abiti.licorsys.util.LazyProvider;
import py.com.abiti.licorsys.util.MyTheme;
import py.com.abiti.licorsys.util.NavigationBar;
import py.com.abiti.licorsys.util.PageTitleUpdater;
...
public class Main extends HorizontalLayout {
	...
	private void SetupNavigator() {
		...
		navigator = new Navigator(LicorSysUI.getCurrent(), content);
